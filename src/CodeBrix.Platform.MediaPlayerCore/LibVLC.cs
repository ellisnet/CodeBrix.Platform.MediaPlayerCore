...
public class LibVLC : Internal
{
    ...
    /// </summary>
    /// <param name="enableDebugLogs">enable verbose debug logs</param>
    /// <param name="useDefaultLibVLCOptions">option to override default libvlc options defined by libvlcsharp. true to use default options, false to override</param>
    /// <param name="options">list of arguments (should be NULL)</param>
    public LibVLC(bool enableDebugLogs, bool useDefaultLibVLCOptions, params string[] options)
        : base(() => MarshalUtils.CreateWithOptions(PatchOptions(options, enableDebugLogs, useDefaultLibVLCOptions), Native.LibVLCNew), Native.LibVLCRelease)
    {
        _gcHandle = GCHandle.Alloc(this);
    }
    ...
    /// <param name="useDefaultLibVLCOptions">use default libvlc options forced by libvlcsharp (recommended)</param>
